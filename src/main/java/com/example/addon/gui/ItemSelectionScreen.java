...
// * Позволяет игроку выбрать Item из списка всех предметов Minecraft.
// *
// * Используется ChestOverlay → openItemSelectionScreen().
// */
...
//
//        // Кнопка закрытия
//        addDrawableChild(ButtonWidget.builder(Text.literal("Отмена"), btn -> close())
//            .dimensions(width / 2 - 40, height - 30, 80, 20)
//            .build());
//    }
//
//    /**
//     * Загружает все предметы из реестра Minecraft.
//     */
...
//
//    /**
//     * Фильтрует предметы по строке поиска.
//     */
...
//
//        drawCenteredText(matrices, textRenderer, "Выберите предмет", width / 2, 5, 0xFFFFFF);
//
//        renderItemList(matrices, mouseX, mouseY);
//
...
//     */
//    private void renderItemList(MatrixStack matrices, int mouseX, int mouseY) {
...
//
//            // Фон строки
//            fill(matrices, startX, y, startX + 200, y + 20, 0x55000000);
//
//            // Иконка предмета
...
//
//            // Название предмета
//            textRenderer.draw(matrices, name, startX + 26, y + 6, 0xFFFFFF);
//
//            // Обработка клика
//            if (isMouseOver(mouseX, mouseY, startX, y, 200, 20)) {
//                fill(matrices, startX, y, startX + 200, y + 20, 0x22FFFFFF);
//
